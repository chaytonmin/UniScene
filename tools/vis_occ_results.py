...
def vis_nuscene():
    ...
    file = "n008-2018-08-01-15-16-36-0400__LIDAR_TOP__1533151742950548_pred.npz" # change this to the file path on your machine
    
    data = np.load(file)
    semantics, imgName, ptName = data['pred'], data['imgName'], data['ptName']
